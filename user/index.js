	...
	if(utils.isMention(data.target)){
		...
		if(data.method.toLowerCase() === "select"){
		 ...
		 if(!member) return message.channel.send("User not found.");
		  ...
		  await new Promise(resolve =>{
		  	...
		  	for(let arg of item){
		  	  ...
		  	  resData.push(member.user.tag);
		  		...
		  		resData.push(member.joinedAt.yyyymmdd()+" "+member.joinedAt.getUTCHours()+":"+member.joinedAt.getUTCMinutes()+":"+member.joinedAt.getUTCSeconds());
		  		else if(arg === "createdDate")
		  		resData.push(member.user.createdAt.yyyymmdd()+" "+member.user.createdAt.getUTCHours()+":"+member.user.createdAt.getUTCMinutes()+":"+member.user.createdAt.getUTCSeconds());
		  	}
		  ...
		  if(resData.length > 0)
		  message.channel.send(resData.join(separator));
			else
		...
		if(typeof where !== "object") where = null;
		  ...
		  members = members.filter(member =>{
                ...
                isUser.push(false);
		  			 ...
		  			 if(i === "username.includes"){
		  			 	if(member.user.username.includes(arg))
		  			    isUser.push(true);
		  			    else
                isUser.push(false);
		  			 }
		  			 ...
		  			 if(i === "username.startsWith"){
		  			 	if(member.user.username.startsWith(arg))
		  			    isUser.push(true);
		  			    else
                isUser.push(false);
		  			 }
		  			 else
		  			 if(i === "username.endsWith"){
		  			 	if(member.user.username.endsWith(arg))
		  			    isUser.push(true);
		  			    else
                isUser.push(false);
		  			 }
                ...
                isUser.push(false);
		  			 ...
		  			 if(i === "discriminator.includes"){
		  			 	if(member.user.discriminator.includes(arg))
		  			   isUser.push(true);
		  			    else
                isUser.push(false);
		  			 }
		  			 else 		  			 
		  			 if(i === "discriminator.startsWith"){
                ...
                isUser.push(false);
		  			 ...
		  			 if(i === "discriminator.endsWith"){
		  			 	if(member.user.discriminator.endsWith(arg))
		  			   isUser.push(true);
		  			    else
                isUser.push(false);
		  			 }
            ...
            if(operator === "<"){
            if(Date.now() - member.joinedAt <= 1000*60*60*28*Number(arg))
                isUser.push(true);
		  			    else
                isUser.push(false);
            }else if(operator === ">"){
            ...
            if(operator === "<"){
            if(Date.now() - member.joinedAt <= 1000*60*60*24*28*Number(arg))
                isUser.push(true);
		  			    else
                isUser.push(false);
            }else if(operator === ">"){
            ...
            if(operator === "<"){
            if(Date.now() - member.joinedAt <= 1000*60*60*24*Number(arg))
                isUser.push(true);
		  			    else
                isUser.push(false);
            }else if(operator === ">"){
            ...
            if(operator === "<"){
            if(Date.now() - member.user.createdAt <= 1000*60*60*24*Number(arg))
                isUser.push(true);
		  			    else
                isUser.push(false);
            }else if(operator === ">"){
            ...
            if(operator === "<"){
            if(Date.now() - member.user.createdAt <= 1000*60*60*28*Number(arg))
                isUser.push(true);
		  			    else
                isUser.push(false);
            }else if(operator === ">"){
            ...
            if(operator === "<"){
            if(Date.now() - member.user.createdAt <= 1000*60*60*28*24*Number(arg))
                isUser.push(true);
		  			    else
                isUser.push(false);
            }else if(operator === ">"){
            	...
            	if(Date.now() - member.user.createdAt === 1000*60*28*60*24*Number(arg))
                isUser.push(true);
		  			    else
                isUser.push(false);
            }
     ...
     member = guild.members.cache.find(u => u.user.username === data.target);
